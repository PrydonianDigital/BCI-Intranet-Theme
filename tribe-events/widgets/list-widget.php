		...
		foreach ( $posts as $post ) :
			...
			<li class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				...
				<div class="tribe-event-duration">
					...
					<?php $speaker = get_post_meta(get_the_ID(), '_event_speaker', true); if($speaker != '') { ?>
					<br />Speaker: <?php echo $speaker; ?>
					<?php } ?>
					<br /><?php echo tribe_get_venue() ?>, <?php echo tribe_get_full_address(); ?>
				</div>
